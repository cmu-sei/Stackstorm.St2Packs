...
This repo handles that by creating a pack that bakes the vsphere and azure packs into a packs image.
...
```
docker build --build-arg PACKS="vsphere=0.11.1 azure=0.4.3" -t cmusei/st2packs:<TAG> st2packs-image
```
...
## NOTE:  This branch uses Python3.  See below for previous message about this:
